...
#### Editing study names, 2020 June 16, 19 #####################################################################
...
levels(neet$Study) <- c("Baggio et al 2015 [15]",
                        "Bania et al 2019 [34]",
                        "Basta et al 2019 [41]",
                        "Benjet et al 2012 [10]", 
                        "Bynner et al 2002 [18]",
                        "Gariepy et al 2018 [30]",
                        "Goldman-Mellor et al 2016 [12]",
                        "Gutierrez-Garcia et al 2017 [13]",
                        "Gutierrez-Garcia et al 2018 [31]",
                        "Hale et al 2018 [42]",
                        "Hammerton et al 2019 [35]",
                        "Henderson et al 2017 [17]",
                        "Lopez-Lopez et al 2019 [32]",
                        "Manhica et al 2019 [40]",
                        "O'Dea et al 2014 [33]",
                        "O'Dea et al 2016 [16]", 
                        "Power et al 2015 [14]",
                        "Rodwell et al 2018 [36]",
                        "Stea et al 2019a [43]",
                        "Stea et al 2019b [37]")
...
write.csv(neet,'neet 20200619.csv')
